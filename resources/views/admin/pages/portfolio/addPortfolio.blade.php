@extends('admin.layouts.master', ['title' => 'Add Portfolio | Burak Çetinkaya'])
@section('css')
<style>
  .atag{
    color: #000;
    ...
    <div class="row">
      <div class="col-md-9 mx-auto">
        <div class="card card-primary">
          ...
          <div class="card-body">
            <form action="{{url('admin/icerikyonetimi/portfolyom/ekle')}}" method="POST" enctype="multipart/form-data">
              @csrf
              ...
              <div class="form-group">
                ...
                <div class="custom-file">
                  <input type="file" accept="image/png, image/jpeg" required class="custom-file-input" name="image" id="customFile">
